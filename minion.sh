...
#  BLUE='\033[034m'
 ...
 echo -e "          ${BLK}  ${YLW}    ${BLK}XXXXXXXXXX${YLW}     ${BLK}  ${RE}"
#  echo -e "          ${BLK}  ${YLW}                   ${BLK}  ${RE}"
 echo -e "          ${BLK}  ${YLW}${PRP}XX${YLW}             ${PRP}XXXX${BLK}  ${RE}"
 echo -e "          ${BLK}  ${YLW} ${PRP}XXX${YLW}        ${PRP}XXXX${YLW}      ${BLK}  ${RE}"
 echo -e "         ${BLK}  ${YLW}  ${PRP}XXXXXXXXXXXXXX${YLW}    ${BLK} ${YLW}  ${RE}"
 echo -e "        ${BLK}  ${YLW}   ${PRP}XXXXXXXXXXXXXX${YLW}   ${BLK}${YLW} ${RE}"
 echo -e "          ${BLK}  ${PRP}XXXXXXXXXXXXXXXXXXX${BLK}  ${RE}"
 echo -e "           ${BLK}   ${PRP}XXXXXXXXXXXXXXX${BLK}   ${RE}"
